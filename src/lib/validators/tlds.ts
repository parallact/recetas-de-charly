export const VALID_TLDS = new Set([
  ...
  'pro', 'aero', 'coop', 'museum', 'travel', 'jobs', 'cat', 'tel', 'mobi',
  'asia', 'post',
  // New gTLDs (common)
  'app', 'dev', 'io', 'tech', 'xyz', 'online', 'site', 'store', 'shop',
  'blog', 'cloud', 'design', 'digital', 'email', 'global', 'live', 'media',
  'network', 'one', 'plus', 'solutions', 'space', 'studio', 'systems',
  'website', 'world', 'zone', 'academy', 'agency', 'company', 'consulting',
  'engineering', 'express', 'foundation', 'group', 'institute', 'marketing',
  'services', 'software', 'technology', 'ventures',
  ...
  'gp', 'gq', 'gr', 'gt', 'gu', 'gw', 'gy', 'hk', 'hm', 'hn', 'hr', 'ht',
  ...
  'tn', 'to', 'tr', 'tt', 'tv', 'tw', 'tz', 'ua', 'ug', 'uk', 'us', 'uy',
